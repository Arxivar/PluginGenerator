...
module.exports = class extends AppGenerator {
	...
	writing() {
		if (this.props.typescript) {
			...
			this.fs.copyTpl(
				this.templatePath('src/PluginWidgetTaskTemplate.ts'),
			...
			// Copio l'html
			this.fs.copyTpl(
				this.templatePath('src/PluginWidgetTaskTemplate.html'),
			...
			// Copio il controller
			this.fs.copyTpl(
				this.templatePath('src/PluginWidgetTaskTemplateDirective.ts'),
			...
			// Copio il css
			this.fs.copyTpl(
				this.templatePath('src/PluginWidgetTaskTemplate.scss'),
